...
if __name__ == '__main__':
    ...
    #                   47, 48, 49, 50]
    hue_body_list = ['{"xy":[0.6915, 0.3083]}', '{"xy":[0.3804, 0.3768]}',
                     '{"xy":[0.1700, 0.7000]}', '{"xy":[0.3804, 0.3768]}',
                     '{"xy":[0.1532, 0.04755]}', '{"xy":[0.3804, 0.3768]}']

    try:
        # while True:
        print "\nColor gamut top point to 4000k test\n"
        Dynamic.execute(group_no_hue, hue_body_list)
        Dynamic.color_gamut.write_log_all("Color_gamut_TC6", "./logs/color_gamut")
